...
/*   Updated: 2018/02/26 21:36:45 by nfinkel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
					...
					unsigned short ws_col)
{
	...
	str = tgoto(move, 1, nb + 5);
	ft_dprintf(fd, "%s%S", str, hor_line);
	str = tgoto(move, ws_col - 28, nb + 5);
